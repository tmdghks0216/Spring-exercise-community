			...
			<div class="inner">
				...
				<section id="banner">
					<div class="content">
						...
						<form action="boardinsert.do" method="post"  name="form1">
							<div class="mb-4">
								<div class="bi">
									...
									<div style="display: inline-block">
										<br> <select name=bcategory id="bcategory" style="width: 200px;">
											...
											<option value="동호회">동호회 홍보</option>
											<option value="운동">개인운동 구인</option>
											<option value="시설추천">시설추천</option>
										</select>
									</div>
									...
									<div style="display: inline-block">
										<br> <select name=condition style="width: 200px;">
											<option value="상관없음">남자&여자</option>
								...
								<br> <input class="form-control" name="title" id="title"
									type="text" placeholder="제목" maxlength=30 style="width: 30;">

								<br>
								<div>
								<textarea name=content id="editor" style="height: 600px"></textarea>
							</div>
							</div>
							<br>
							    <div class="mb-3">
               ...
               <br>
                  ...
                  <input readonly="readonly" required type="text" class="form-control mt-1"
                     id="sample5_address" name=badrr placeholder="주소 검색을 이용해주세요.">
